...
if opts.minify_level and not minify_defaults[opts.minify_level] then
	print("Unknown minify level: "..opts.minify_level);
	print("Available minify levels: none, basic, default, full, debug");
end
